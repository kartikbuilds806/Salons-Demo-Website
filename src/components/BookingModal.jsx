...
const BookingModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const phoneNumber = "1234567890"; // Salon phone number
    const text = `Hi, I want to book an appointment.%0A*Name:* ${formData.name}%0A*Phone:* ${formData.phone}%0A*Service:* ${formData.service}%0A*Date:* ${formData.date}%0A*Time:* ${formData.time}`;
    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          >
            {/* Header */}
            <div className="bg-blush px-6 py-4 flex justify-between items-center border-b border-beige">
